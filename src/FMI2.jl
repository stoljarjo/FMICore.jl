...
mutable struct FMU2Component{F} 
    ...
    # deprecated
    senseFunc::Symbol
    jac_ẋy_x::Union{Matrix{fmi2Real}, Nothing, AbstractSparseMatrixCSC{fmi2Real, Int64}}
    jac_ẋy_u::Union{Matrix{fmi2Real}, Nothing, AbstractSparseMatrixCSC{fmi2Real, Int64}}
